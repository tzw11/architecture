...
public class TempAltPressFilter extends FilterFramework
{
    public TempAltPressFilter(){
        super(1,1);
    }
  ...
  public byte[] intToBytes(int x){
    ...
    int IdLength = 4;				// This is the length of IDs in the byte stream
		...
		System.out.print( "\n" + this.getName() + "::TempAltPressFilter Reading ");
        ...
        */
			...
			{
				ClosePorts();
				System.out.print( "\n" + this.getName() + "::TempAltPressFilter Exiting; bytes read: " + bytesread + " bytes written: " + byteswritten );
				break;
